...
public:
    ...
    void setDistortionType(const int choice, juce::AudioBuffer<float> &buffer, float gain, float level, float freq, double sampleRate, int numChannels);
    ...
    void tanh(juce::AudioBuffer<float>& buffer, float gain, float level, int numChannels);
    ...
    void boost(juce::AudioBuffer<float>& buffer, float gain, float freq, double sampleRate, int numChannels);
